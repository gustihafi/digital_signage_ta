    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="<?php echo base_url('admin/proses_edit_profil') ?>">
                <div class="card-body">
                  <div class="row">
                      <div class="col-md-6">
                          ...
                          <div class="form-group">                                        
                              ...
                              <input type="checkbox" name="pwd_lama" value="1" /><br>
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger" href="<?php echo base_url('admin/profil'); ?>"> Cancel</a>
                </div>
            </div>
      </div><!-- /.container-fluid -->
    </section>
